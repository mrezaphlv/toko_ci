  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    ...
                    <form class="" action="<?php echo base_url('Users/add'); ?>" id="addUserForm" method="post">
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputName" class="col-md-2 col-form-label">Nama</label>
                                    <div class="col-md-9">
                                        <input class="form-control" value="<?php echo set_value('in_name'); ?>" name="in_name" id="in_name" type="text" placeholder=" "></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="exampleInputLastName" class="col-md-2 col-form-label">Email</label>
                                       <div class="col-md-9"> 
                                        <input class="form-control" name="email" id="email" placeholder=""></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="exampleInputLastName" class="col-md-2 col-form-label">Username</label>
                                        <div class="col-md-10">
                                        <input class="form-control" name="username" id="username" type="text" placeholder=""></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="exampleInputLastName" class="col-md-2 col-form-label">Password</label>
                                        <div class="col-md-10">
                                        <input class="form-control" name="password" id="password" type="password" placeholder=""></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="exampleInputLastName" class="col-md-2 col-form-label">Password Confirm</label>
                                        <div class="col-md-10">
                                        <input class="form-control" name="passconf" id="passconf" type="password" placeholder=""></div>
                                    </div>
...
$('#data_list').on('click','.item_edit',function(){
         ...
         $('#btn_hapus').on('click',function(){
            ...
            window.location.href="<?php echo base_url(); ?>Users/delete/"+kode;
            // $.ajax({
            // type : "POST",
